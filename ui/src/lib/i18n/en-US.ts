export default {
  ...
  instanceDetail: {
    ...
    usage: {
      ...
      requests: 'Requests',
      lastUsed: 'Last Used',
      empty: 'No usage records for this window.',
      windows: {
        '24h': '24H',
        '7d': '7D',
        '30d': '30D',
    ...
    integration: {
      ...
      successTrigger: 'Success Trigger',
      maxConcurrentTasks: 'Max Concurrent Tasks',
      agentId: 'Agent ID',
      workflowFile: 'Workflow File',
      availableTrackers: 'Available Trackers',
      running: 'Running',
      stopped: 'Stopped',
      pipelineCount: 'Pipelines',
      noTrackers: 'No tracker instances discovered.',
      trackerSnapshot: 'Tracker Snapshot',
      noTrackerSnapshot: 'Tracker snapshot is not available.',
