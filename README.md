...
- [x] 建立基础能力契约，区分 Hub Bridge / Runtime Support / UI Productization
- [x] 完成全局 Agents 管理页与 Connections 基础运营页
- [x] 为 Providers / Channels 增加 linked instances 与 orphaned 标识
- [ ] 接入 nullclaw runtime capability detection
- [ ] 中文化所有界面文本
- [ ] 中文化所有文档
- [ ] 中文化错误提示和日志信息
- [ ] 优化仪表盘布局
